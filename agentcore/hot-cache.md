...
- Telegram photo vision (2026-08-29): router `2.5.7` uses `gemini-3.6-flash`. 3.7 Flash 503'd on the Silver visit photo after 82s. Webhook ACK-first from 2.5.6 is still in place.
