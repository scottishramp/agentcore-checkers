...
- Telegram photo vision (2026-08-29): router `2.5.6` ACKs the webhook immediately and lets Gemini use the full 300s function lifetime. 35s was still aborting mid-describe.
