...
- Send a daily school digest as a shared Google Doc (Important / per kid / General). Telegram pings only the action items plus the Doc link. Playbook: `agentcore/knowledge/playbooks/school-comms-digest.md`.
