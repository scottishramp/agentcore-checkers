...
2. Move or summarize it into the right place.
3. Update `index.md` if it creates or changes an important page.
4. Add a `log.md` entry for meaningful ingests or decisions.
