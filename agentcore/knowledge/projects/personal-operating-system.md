...
- Nathan (Brian, 2026-08-18): plays school football; practice daily.
- Send a daily school digest as a shared Google Doc (Important / per kid / General). This-week items are bold; each bullet has a hyperlinked Link. The sweep ingests new teachers and sports onto the roster. Telegram pings only the action items plus the Doc link. Playbook: `agentcore/knowledge/playbooks/school-comms-digest.md`.
